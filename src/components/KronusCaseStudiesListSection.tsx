      ...
      <div className="mx-auto max-w-[100rem] space-y-24 lg:space-y-28">
        {caseStudies.map((study) => {
          ...
          return (
            ...
            >
              <div className="overflow-hidden bg-[#050505] shadow-[0_18px_40px_rgba(0,0,0,0.08)]">
              ...
              <div className="min-w-0">
                <h2 className="max-w-[58rem] font-serif text-[clamp(2.3rem,4.35vw,4.7rem)] font-light leading-[0.95] tracking-[-0.06em] text-[#211913]">
                  {study.title}
                </h2>

                {study.meta?.length ? (
                  <p className="mt-4 text-[clamp(1.2rem,1.8vw,1.8rem)] leading-[1.35] tracking-[-0.03em] text-[#28211a]">
                ...
                <div className="mt-8 overflow-hidden bg-[linear-gradient(90deg,#070401_0%,#070401_71%,rgba(89,75,51,0.9)_88%,rgba(10,6,2,0.98)_100%)] px-5 py-4 sm:px-7 sm:py-5">
                ...
                <p className="mt-8 max-w-[74rem] text-[clamp(1.65rem,2.3vw,2.55rem)] font-semibold leading-[1.15] tracking-[-0.045em] text-[#2c241d]">
                  {study.result}
                </p>
              </div>
              ...
              <div className="flex items-start xl:justify-end">
                {isActionableLink ? (
                  ...
                  <span className="inline-flex h-11 w-11 items-center justify-center text-[#2a221b]" aria-hidden="true">
                    <ArrowUpRightIcon />
                  </span>
                )}
              </div>
