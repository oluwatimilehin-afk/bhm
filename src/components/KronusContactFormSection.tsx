...
export default function KronusContactFormSection({
  ...
  return (
    <section className={`bg-[#ede9e3] px-5 py-20 text-[#1a110b] sm:px-8 md:px-10 lg:px-14 lg:py-24 xl:py-28 ${className}`.trim()}>
      <div className="mx-auto grid max-w-[1620px] gap-14 xl:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] xl:gap-0">
        <div className="max-w-[43rem] xl:pr-16">
          <p className="text-[1.4rem] font-medium tracking-[-0.04em] text-[#1c120b] sm:text-[1.65rem] lg:text-[1.9rem]">
            {eyebrow}
          </p>

          <h2 className="mt-7 text-[#120905] leading-[0.92] tracking-[-0.075em]">
          ...
          <p className="mt-7 max-w-[40rem] text-balance text-[1.2rem] leading-[1.42] tracking-[-0.03em] text-[#3d322a] sm:text-[1.4rem] lg:text-[1.6rem]">
            {description}
          </p>
        </div>
        ...
        <div className="xl:border-l xl:border-[#978d82] xl:pl-14 2xl:pl-16">
          ...
          >
            ...
            <UnderlineField label="Your Email" type="email" required />
            <UnderlineField label="Your Phone" type="tel" required />
